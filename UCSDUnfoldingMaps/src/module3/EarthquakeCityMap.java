...
/*	    if (earthquakes.size() > 0) {    	
	    ...
	    if (earthquakes.size() > 0){
	    	List<PointFeature> allfeature = new ArrayList<>();
	    	for (PointFeature ffeatures : earthquakes ){
	    		markers.add(new SimplePointMarker(ffeatures.getLocation(), ffeatures.getProperties()));
	    	}
